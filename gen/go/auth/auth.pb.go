...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\x04role\x18\x02 \x01(\tR\x04role2P\n" +
	"\x04Auth\x12H\n" +
	"\rValidateToken\x12\x1a.auth.ValidateTokenRequest\x1a\x1b.auth.ValidateTokenResponseB3Z1github.com/GoSMRiST/protosLibary/gen/go/auth;authb\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: auth.Auth.ValidateToken:input_type -> auth.ValidateTokenRequest
	1, // 1: auth.Auth.ValidateToken:output_type -> auth.ValidateTokenResponse
