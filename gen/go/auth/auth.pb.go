...
const file_auth_auth_proto_rawDesc = "" +
	...
	"\aIsAdmin\x12\x14.auth.IsAdminRequest\x1a\x15.auth.IsAdminResponseB3Z1github.com/GoSMRiST/protosLibary/gen/go/auth;authb\x06proto3"
...
var file_auth_auth_proto_depIdxs = []int32{
	0, // 0: auth.Book.Register:input_type -> auth.RegisterRequest
	2, // 1: auth.Book.Login:input_type -> auth.LoginRequest
	4, // 2: auth.Book.IsAdmin:input_type -> auth.IsAdminRequest
	1, // 3: auth.Book.Register:output_type -> auth.RegisterResponse
	3, // 4: auth.Book.Login:output_type -> auth.LoginResponse
	5, // 5: auth.Book.IsAdmin:output_type -> auth.IsAdminResponse
